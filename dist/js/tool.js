...
var wizardComponents = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)([]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  setup: function setup() {
    var allWizardFields = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)([]);
    var wizardComponents = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)([]);
  ...
  methods: {
    ...
    reloadFromResponse: function reloadFromResponse(response) {
      var vue = this;
    ...
    instanceUrl: function instanceUrl() {
    ...
    resetButton: function resetButton() {
      this.finished = false;
      this.errors = new form_backend_validation__WEBPACK_IMPORTED_MODULE_1__.Errors();
      this.reload();
      this.currentStep = 0;
      this.updateScrollPosition(0);
    },
    currentStepData: function currentStepData() {
          ...
          Nova.request().post(apiUrl, formData, config).then(function (response) {
            ...
            if (error.response) {
              if (error.response.status === 500) {
                ...
                _this3.jumpToFirstStepWithError();
              }
              // console.log('Error status:', error.response.status);
              // console.log('Error data:', error.response.data);
            }
    ...
    focusOnFirstFieldInStep: function focusOnFirstFieldInStep() {
      var _this4 = this;
      var attribute = this.steps[this.currentStep].fields[0].attribute;
      if (this.errors.any()) {
        var found = false;
        this.steps[this.currentStep].fields.forEach(function (field) {
          if (!found && _this4.errors.has(field.attribute)) {
            attribute = field.attribute;
            found = true;
          }
        });
      }
      var divElement = document.querySelector('div[data-attribute="' + attribute + '"]');
      if (divElement) {
        var firstInput = divElement.querySelector("input");
        if (firstInput) {
          firstInput.focus();
        }
      }
    },
    jumpToFirstStepWithError: function jumpToFirstStepWithError() {
      var _this5 = this;
      if (!this.errors.any()) {
        return;
      }
      ...
      this.steps.forEach(function (step) {
        if (targetStep == -1) {
          step.fields.forEach(function (field) {
            if (targetStep == -1 && _this5.errors.has(field.attribute)) {
    ...
    updateScrollPosition: function updateScrollPosition(animate) {
      var _this6 = this;
      var container = document.querySelector(".nova-wizard");
      gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(container, {
        scrollTop: 0,
        // Scroll to the top (0 pixels from the top)
        duration: 3,
      ...
      gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to("#progress-bar", {
        duration: animate,
      ...
      setTimeout(function () {
        _this6.focusOnFirstFieldInStep();
      }, animate * 1000);
    }
  },
  data: function data() {
    return {
      ...
      windowTitle: "",
      allWizardFields: [],
      errors: new form_backend_validation__WEBPACK_IMPORTED_MODULE_1__.Errors(),
      finished: false,
      finishedMessage: "✅",
      title: "",
      steps: [],
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["nova-wizard", {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [_hoisted_1, !$data.finished ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("form", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.steps, function (step, index) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(step.title), 1 /* TEXT */), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(step.fields, function (field) {
          return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
            key: field,
            "class": "flex flex-col"
          }, [field.status ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
            key: 0,
            textContent: (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)("Status: ".concat(field.status)),
            "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["font-bold uppercase", {
          ...
          }, null, 10 /* CLASS, PROPS */, _hoisted_5)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)((0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveDynamicComponent)('form-' + field.component), {
            "class": "step-field",
            ...
            field: field,
            "show-help-text": true
          }, null, 8 /* PROPS */, ["data-attribute", "options", "errors", "field"])), _hoisted_6]);
        }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */)), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, $data.currentStep == index]]);
      }), 256 /* UNKEYED_FRAGMENT */))])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), !!$data.finished ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", {
        innerHTML: $data.finishedMessage
      }, null, 8 /* PROPS */, _hoisted_8)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)];
    }),
    _: 1 /* STABLE */
  }), !$data.finished ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_9, [$data.currentStep == $data.steps.length - 1 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultButton, {
    key: 0,
    "class": "button",
    align: "center",
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.__("Submit")), 1 /* TEXT */)];
    }),

    _: 1 /* STABLE */
  })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.currentStep < $data.steps.length - 1 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_OutlineButton, {
    key: 1,
    "class": "button",
    align: "center",
    onClick: _cache[1] || (_cache[1] = function ($event) {
      return $options.nextButton();
    })
  }, {
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.__("Next")) + " ", 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Icon, {
        "class": "icon",
        type: "arrow-right"
      })];
    }),
    _: 1 /* STABLE */
  })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.currentStep > 0 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_ToolbarButton, {
    key: 2,
    "class": "button",
    align: "center",
    onClick: _cache[2] || (_cache[2] = function ($event) {
      return $options.previousButton();
    })
  }, {
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Icon, {
        "class": "icon",
        type: "arrow-left"
      }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.__("Previous")), 1 /* TEXT */)];
    }),

    _: 1 /* STABLE */
  })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.finished ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_10, [$data.finished ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_OutlineButton, {
    key: 0,
    "class": "button",
    align: "center",
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Icon, {
        "class": "icon",
        type: "refresh"
      }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.__("Start over")), 1 /* TEXT */)];
    }),

    _: 1 /* STABLE */
  })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 2 /* CLASS */);
}
